...
public:
	//constructor
	TreeSet(set<unsigned int> treeids);
	TreeSet(set<unsigned int> treeids, bool inverseids);
	TreeSet(set<unsigned int> treeids, bool inverseids, vector<float> branchlengths);
	...
	*/
	...
	set<unsigned int> tree_ids;
	bool is_inverse;
	vector<float> branch_lengths;
	bool no_branch_lengths;
	
	//set<unsigned int> get_trees();
